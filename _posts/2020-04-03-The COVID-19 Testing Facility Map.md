---
layout: post
title: The COVID-19 Testing Facilites Map
subtitle: An attempt to map (currently) inexsitent data
tags: [Blog Posts]
comments: false
---
...
If you want to learn more about the project and maybe even want to contribute to it, I suggest you have a look at the repository. The [README.md](https://github.com/IneffableKoD/cov19testmap/blob/master/README.md) file has some more background on the history of the project, and the [CONTRIBUTING.md](https://github.com/IneffableKoD/cov19testmap/blob/master/README.md) file has information on how you can contribute to the project. 
...
Last but not least, I want to say _thank you_ to everyone that has been a help or has supplied code/data for this project!

Stay healthy, stay safe, and #StayHomeSaveLifes!

[**LINK TO THE MAP**](http://ineff.ch/cov19testmap/)

[**LINK TO THE REPOSITORY**](https://github.com/IneffableKoD/cov19testmap/)
